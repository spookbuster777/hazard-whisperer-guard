...
const DuplicateClusterList = ({ clusters, onViewReport }: DuplicateClusterListProps) => {
  ...
  const getClusterData = (cluster: ClusterInfo) => {
    ...
    return {
      ...
      site: representativeReport?.site || "-",
      lokasi: representativeReport?.lokasiArea || representativeReport?.lokasi || "-",
      detailLokasi: representativeReport?.detailLokasi || "-",
      ketidaksesuaian: representativeReport?.ketidaksesuaian || "-",
      subKetidaksesuaian: representativeReport?.subKetidaksesuaian || "-",
      quickAction: representativeReport?.quickAction || "-",
      representativeDesc: representativeReport?.deskripsiTemuan || cluster.name,
      geoClusterId: `GCL-${cluster.id.replace('C-', '')}`,
      lexClusterId: `LCL-${cluster.id.replace('C-', '')}`,
      semClusterId: `SCL-${cluster.id.replace('C-', '')}`,
    };
  };
...
export default DuplicateClusterList;
